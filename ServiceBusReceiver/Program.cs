...
namespace ServiceBusReceiver
{
    class Program
    {
        const string connectionString = "Endpoint=sb://intro-to.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=IaKDzk7h8FRfh50qf7gb/yXBhs4d1fF1Gf9xrIOcqts=";
